...
function start() {
	answer = commn[Math.floor(Math.random() * commn.length)] ;
}
...
function check() {
	...
	if (words.includes(word) && active) {
		let = newInner = "" ;
		const gyrs = colors(word) ;
...
// the size of this list is effectively the difficulty
const commn = [
...
// Allow players to guess less common words.
const words = [
